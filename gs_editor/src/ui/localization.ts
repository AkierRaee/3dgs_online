        ...
        resources: {
            de: {
                translation: {
                    ...
                    'shortcuts.play-pause-timeline': 'Abspielen/Stoppen Timeline',
            ...
            en: {
                translation: {
                    ...
                    // DLSS Settings
                    'dlss.header': 'NEURAL UPSCALING SETTINGS',
                    'dlss.enable': 'Enable Neural Upscaling',
                    'dlss.quality': 'Quality Mode',
                    'dlss.performance': 'Performance',
                    'dlss.balanced': 'Balanced',
                    'dlss.qualityMode': 'Quality',
                    'dlss.ultra': 'Ultra Performance',
                    'dlss.temporal': 'Temporal Accumulation',
                    'dlss.sharpening': 'Sharpening',
                    'dlss.description': 'Neural upscaling provides AI-enhanced super resolution for improved visual quality and performance.',
                    'dlss.performanceDesc': 'Performance mode: Highest performance (2.0x upscaling) with moderate quality improvement.',
                    'dlss.balancedDesc': 'Balanced mode: Good balance between performance and quality (1.7x upscaling).',
                    'dlss.qualityDesc': 'Quality mode: Best visual quality (1.5x upscaling) with good performance.',
                    'dlss.ultraDesc': 'Ultra Performance mode: Maximum performance (2.3x upscaling) for very demanding scenes.',
                    ...
                    'shortcuts.undo': 'Undo',
                    'shortcuts.redo': 'Redo',
                    'shortcuts.play-pause-timeline': 'Play/Pause Timeline',
                    ...
                    'fps.tooltip': 'Click for detailed metrics, F3 to toggle visibility',
                    'fps.metrics.logged': 'Performance metrics logged to console',
                    'fps.enabled': 'FPS Counter enabled',
                    'fps.disabled': 'FPS Counter disabled'
                }
            },
            fr: {
                translation: {
                    ...
                    'shortcuts.play-pause-timeline': 'Jouer/Arrêter Timeline',
            ...
            ja: {
                translation: {
                    ...
                    'shortcuts.other': 'その他',
                    'shortcuts.select-next-splat': '次のSplatを選択',
                    'shortcuts.undo': '元に戻す',
                    'shortcuts.redo': 'やり直し',
                    'shortcuts.play-pause-timeline': '再生/停止Timeline',
                    'shortcuts.toggle-splat-overlay': 'スプラットオーバーレイの切り替え',
                    'shortcuts.focus-camera': '現在の選択にカメラの焦点を合わせる',
                    ...
                    'popup.copy-to-clipboard': 'クリップボードにリンクをコピー',

                    // Right toolbar
                    'tooltip.splat-mode': 'Splatモード ( M )',
                    'tooltip.show-hide': 'スプラットの表示/非表示 ( Space )',
                    'tooltip.frame-selection': 'フレーム選択 ( F )',
                    ...
                    'tooltip.local-space': 'ローカル座標系',
                    'tooltip.bound-center': '境界中心を使用',
            ...
            ko: {
                translation: {
                    ...
                    'shortcuts.play-pause-timeline': '재생/정지 Timeline',
                    'shortcuts.toggle-splat-overlay': '스플래츠 오버레이 전환',
                    'shortcuts.focus-camera': '현재 선택에 카메라 초점 맞추기',
            ...
            'zh-CN': {
                translation: {
                    ...
                    'shortcuts.undo': '撤销',
                    'shortcuts.redo': '重做',
                    'shortcuts.play-pause-timeline': '播放/暂停 Timeline',
                    ...
                    // FPS Counter
                    'fps.counter': 'FPS计数器',
                    'fps.tooltip': '点击查看详细指标，F3切换显示/隐藏',
                    'fps.metrics.logged': '性能指标已记录到控制台',
                    'fps.enabled': 'FPS计数器已启用',
                    'fps.disabled': 'FPS计数器已禁用'
                }
            }
        },
        interpolation: {
